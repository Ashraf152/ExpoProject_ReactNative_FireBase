    ...
    <View style={styles.container}>
      ...
      <View>
        ...
        <Text style={styles.text}>
          Please note that only one Business can be uploaded. {"\n"}If you
          upload it again, the existing Business will be deleted and re-uploaded{" "}
        </Text>

        <TouchableOpacity
          style={styles.uploadButton}
          onPress={() => navigation.navigate("NewbusinessUpload")}
        >
          <Text>Upload Business</Text>
        </TouchableOpacity>
      </View>
      ...
      <View
        style={{
          ...
          height: Platform.OS === "android" ? "25%" : "17%",
          marginTop: Platform.OS === "android" ? "55%" : "25%",
        }}
      >
