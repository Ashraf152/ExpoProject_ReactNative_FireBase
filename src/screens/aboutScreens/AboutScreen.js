...
const AboutScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{ fontSize: 30,marginLeft:'1%' }}>About Us</Text>
      <Text style={{ fontSize: 15,marginLeft:'1%' }}>
        A little about us, we are both friends we met during our studies and
        that's where the idea came from. Our goal is to promote the weak
        community that doesn't have financial capabilities, for example a young
        entrepreneur with an amazing idea but doesn't have the financial ability
        to register it as a patent or publish it and so on The same goes for a
        business owner who wants to expand the business and this is where we
        come into the picture and help the weak community find the right
        investor at no cost and even build a business plan for free for business
        owners or ideas
      </Text>
      ...
      <View
        style={{
          ...
          marginTop: Platform.OS === "android" ? "58%" : "30%",
        }}
      >
